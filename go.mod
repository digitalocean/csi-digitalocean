...
replace k8s.io/apimachinery => k8s.io/apimachinery v0.25.3-rc.0
...
replace k8s.io/code-generator => k8s.io/code-generator v0.25.3-rc.0
...
replace k8s.io/cri-api => k8s.io/cri-api v0.25.3-rc.0
